  ...
  return (
    <div class="container learn">
      <Helmet>
        ...
        <meta
          name="description"
          content="Read more on Tinyman AMM DEX design, principles and contracts. See links to smart contracts on Algorand, read audit reports, FAQ, Tinyman blogs, and discover Tinyman’s DeFi products on GitHub."
        />
      </Helmet>
      ...
      <div class="sub_intro">
        ...
        <svg
          class="page_title_svg"
          width="1012"
          height="212"
          viewBox="0 0 1012 212"
          fill="none"
        ...
        <div class="intro_description">
          <p>
            Learn about the core concepts and the main points of Tinyman and
            DeFi products of Algorand ecosystem. Swapping, pooling, fees, and
            more...
          </p>
        </div>
        <div class="section quick_links">
          <ul>
            <li>
              <a
                href="https://tinymanorg.medium.com/who-is-this-tinyman-6eb2e787bf74"
                target="_blank"
                rel="noreferrer"
              >
                <svg
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M10 2H6C3.79086 2 2 3.79086 2 6V10C2 12.2091 3.79086 14 6 14H10C12.2091 14 14 12.2091 14 10V6C14 3.79086 12.2091 2 10 2ZM6 0C2.68629 0 0 2.68629 0 6V10C0 13.3137 2.68629 16 6 16H10C13.3137 16 16 13.3137 16 10V6C16 2.68629 13.3137 0 10 0H6ZM7 8H9V12H7V8ZM9 4H7V6H9V4Z"
                    fill="black"
                  />
                </svg>
                What is Tinyman?
              ...
              >
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M4.5 0C2.84315 0 1.5 1.34315 1.5 3V13C1.5 14.6569 2.84315 16 4.5 16H13.5H14.5V14H14V12H14.5V10V2V1V0H4.5ZM12.5 2H4.5C3.94772 2 3.5 2.44772 3.5 3V10.1707C3.81278 10.0602 4.14936 10 4.5 10H12.5V2ZM4.5 12H12V14H4.5C3.94772 14 3.5 13.5523 3.5 13C3.5 12.4477 3.94772 12 4.5 12Z"
                    fill="black"
                  />
                </svg>
                Documentation
            ...
            <li>
              <a
                href="https://docs.tinyman.org/faq"
                target="_blank"
                rel="noreferrer"
              >
                <svg
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M0 3.5C0 1.567 1.567 0 3.5 0H12.5C14.433 0 16 1.567 16 3.5C16 5.433 14.433 7 12.5 7H3.5C1.567 7 0 5.433 0 3.5ZM3.5 2H12.5C13.3284 2 14 2.67157 14 3.5C14 4.32843 13.3284 5 12.5 5H3.5C2.67157 5 2 4.32843 2 3.5C2 2.67157 2.67157 2 3.5 2Z"
                    fill="black"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M0 12.5C0 10.567 1.567 9 3.5 9H12.5C14.433 9 16 10.567 16 12.5C16 14.433 14.433 16 12.5 16H3.5C1.567 16 0 14.433 0 12.5ZM3.5 11H12.5C13.3284 11 14 11.6716 14 12.5C14 13.3284 13.3284 14 12.5 14H3.5C2.67157 14 2 13.3284 2 12.5C2 11.6716 2.67157 11 3.5 11Z"
                    fill="black"
                  />
                </svg>
            ...
            <li>
              <a
                href="https://docs.tinyman.org/protocol-specification"
                target="_blank"
                rel="noreferrer"
              >
                <svg
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M16 3C16 1.34315 14.6569 0 13 0H3C1.34962 0 0.0104981 1.33267 6.1423e-05 2.9806L0 3V13C0 14.6569 1.34315 16 3 16H13C14.6569 16 16 14.6569 16 13V3ZM3 2C2.51675 2 2.11356 2.34278 2.02032 2.79847C2.007 2.86356 2 2.93096 2 3V5H14V3C14 2.44772 13.5523 2 13 2H3ZM9 14H12C13.1046 14 14 13.1046 14 12V7H9V14ZM7 7V14H3C2.44772 14 2 13.5523 2 13V7H7Z"
                    fill="black"
                  />
                </svg>
            ...
            <li>
              <a
                href="https://docs.tinyman.org/fees"
                target="_blank"
                rel="noreferrer"
              >
                <svg
                ...
                >
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M15 4V5.35418C15.6224 6.05931 16 6.98555 16 8V12C16 14.2091 14.2091 16 12 16H4C1.79086 16 0 14.2091 0 12V4C0 1.79086 1.79086 0 4 0H11C13.2091 0 15 1.79086 15 4ZM4 2H11C12.1046 2 13 2.89543 13 4V4.12602C12.6804 4.04375 12.3453 4 12 4H4C3.27143 4 2.58835 4.19479 2 4.53513V4C2 2.89543 2.89543 2 4 2ZM12 6H4C2.89543 6 2 6.89543 2 8V12C2 13.1046 2.89543 14 4 14H12C13.1046 14 14 13.1046 14 12V8C14 6.89543 13.1046 6 12 6Z"
                    fill="black"
                  />
                </svg>
                Fees
      ...
      <div class="section helper">
        <a
          class="helper_box"
          href="https://www.youtube.com/playlist?list=PLFRZV55GOPLtWhefSq2lOS12R4mDLzPFZ"
          target="_blank"
          rel="noreferrer"
        >
          <h5>Tinyman Tutorials</h5>
          <p>
            Tinyman provides basic tutorials for beginner swappers and liquidity
            providers.
          </p>
        </a>
        <a
          class="helper_box"
          href="https://tinymanorg.medium.com/"
          target="_blank"
          rel="noreferrer"
        >
          <h5>Tinyman Blog</h5>
          <p>
            Follow all the developments and updates in Tinyman with all the
            details.
          </p>
        </a>
        <a
        ...
        >
          ...
          <p>
            Still have any questions? Or, are you interested in contributing to
            Tinyman? We are eager to hear your ideas!
          </p>
        </a>
      </div>
        ...
        <div class="developers">
          <ul>
            <li>
              <h4>Contracts</h4>
              <p>
                The contract and protocol design for Tinyman v2 is significantly
                different from v1 as it uses more recent features of Algorand
                Virtual Machine, thanks to Tealish.
              </p>
            </li>
            <li>
              <a
                href="https://github.com/tinymanorg/tinyman-amm-contracts-v2"
                target="_blank"
                rel="noreferrer"
              >
                <svg
                ...
                >
                  <path
                    d="M11.1394 3.45001L1.1001 13.4893L2.51431 14.9036L12.5539 4.86401L12.5539 12.7637H14.5539L14.5539 1.45001L3.24015 1.45001L3.24015 3.45001L11.1394 3.45001Z"
                    fill="black"
                  />
                </svg>
            ...
            <li>
              <a
                href="https://docs.tinyman.org/audits-and-security"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://immunefi.com/bounty/tinymanv2/"
                target="_blank"
                rel="noreferrer"
              >
                <svg
          ...
          <ul>
            <li>
              <h4>Official SDKs</h4>
              <p>
                These SDKs have been developed and are maintained by the Tinyman
                core development team.
              </p>
            </li>
            <li>
              <a
                href="https://github.com/tinymanorg/tinyman-py-sdk"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://github.com/tinymanorg/tinyman-js-sdk"
                target="_blank"
                rel="noreferrer"
              >
                <svg
      ...
      <div class="section products">
        <div class="product_box asa-list">
          ...
          <div class="content">
            <p>
              All project icons built on Algorand are collected in one place
              where everyone can easily access and use.
            </p>
            <a
        ...
        <div class="product_box tealish">
          ...
          <div class="content">
            <p>
              Tealish is a readable language for the Algorand Virtual Machine,
              built by Tinyman team.
            </p>
            <a
